...
const Index = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#050508] flex flex-col relative overflow-hidden">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-red-600 via-red-700 to-black py-4 px-4 text-center relative z-10 shadow-lg shrink-0">
        <h1 className="text-3xl font-black text-white mb-1 tracking-tighter">USIR</h1>
        <p className="text-white/80 text-[10px] font-bold tracking-[0.2em] uppercase">Calendario de Turnos</p>
        
        {isInstallable && (
          <button
            onClick={installApp}
            className="absolute top-3 right-4 bg-white/10 backdrop-blur-md text-white border border-white/20 px-3 py-1 rounded-full text-[10px] font-medium hover:bg-white/20 transition-colors"
          >
            Instalar
          </button>
        )}
      ...
      {/* Calendario - Ahora ocupa todo el ancho y alto restante */}
      <div className="flex-1 overflow-hidden relative z-10">
        <div className="h-full w-full bg-white/5 backdrop-blur-xl border-x border-white/10 flex flex-col">
          <CalendarView
      ...
      <div className="relative z-10 bg-black/40 backdrop-blur-2xl border-t border-white/10 py-3 px-4 shrink-0">
        <div className="flex justify-center items-center w-full">
          <button
            ...
            title="Modo Pintura"
          >
            <div className={`p-2.5 rounded-xl transition-all duration-300 ${isPaintMode ? 'bg-blue-500/20 shadow-[0_0_20px_rgba(59,130,246,0.3)]' : 'bg-white/5 group-hover:bg-white/10'}`}>
          ...
          {isPaintMode && (
            <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4 py-1 rounded-full text-[10px] font-bold shadow-[0_0_15px_rgba(59,130,246,0.5)] animate-bounce">
