...
const Index = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#050508] flex flex-col relative overflow-hidden p-3 sm:p-4">
      ...
      {/* Header Redondeado - Corregido el artefacto visual */}
      <div className="bg-gradient-to-r from-red-600 to-black py-4 px-4 text-center relative z-10 shadow-lg rounded-3xl mb-3 sm:mb-4 border border-white/10 overflow-hidden">
